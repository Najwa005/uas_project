                            ...
                            <form action="{{ url('mahasiswa') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2bs4 @error('prodi_id') is-invalid @enderror"
                                            style="width: 100%;" id="prodi" name="prodi_id">
                                            <option value="">Pilih Prodi</option>
                                            @foreach ($prodi as $d)
                                                <option value="{{ $d['id'] }}"
                                                    {{ $d->id == old('prodi_id') ? 'SELECTED' : '' }}>{{ $d['nama_prodi'] }}
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('prodi_id')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="no_hp"
                                            class="form-control @error('no_hp') is-invalid @enderror" id="nohp"
